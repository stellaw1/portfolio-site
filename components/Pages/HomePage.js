            ...
            <div className='mx-auto md:mt-56 flex flex-row justify-center items-ceter space-x-20'>
                <div className="w-3/4 flex flex-col space-y-20">
                    ...
                    <div className='font-bold md:inline-flex lg:flex-row md:w-auto w-full lg:items-center flex flex-col'>
                        <Link href='/project'>
                        <a className='lg:inline-flex md:w-auto w-full mx-4 px-3 py-2 rounded items-center justify-center transition-colors duration-300 ease-in-out hover:bg-sky-500/50 text-lg lg:text-2xl hover:text-white '>
                            Projects
                        </a>
                        </Link>
                        <Link href='/blog'>
