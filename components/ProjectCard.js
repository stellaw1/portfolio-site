        ...
        <div className="w-full rounded-xl drop-shadow mx-auto overflow-hidden bg-[#C0D6DF] mb-12 transition hover:shadow-md">
            <div className={`md:flex ${props.reverse}`}>
                <div className="md:shrink-0">
                    <img className="h-48 w-full object-cover md:h-full md:w-48 lg:w-64" src={`/images/projects/${props.img}`} alt={props.title} />
                </div>
                <div className="w-full p-8 space-y-3">
                    ...
                    <div className="flex flex-row-reverse">
                        <Link href={`/project/${props.slug}`}>
                            <button type="button" className="px-3 text-sm text-[#86ACC2] font-medium bg-white rounded-lg hover:bg-gray-100">VIEW...</button>
                        </Link>
                        <a href={`${props.github}`}>
