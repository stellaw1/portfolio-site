...
export default function BlogHero(props) {
    return (
        <div className="mx-auto rounded-lg border border-gray-500">
            <button type="button" className="inline-flex relative items-center py-2 px-4 w-full text-sm font-medium border-b border-gray-400 hover:bg-gray-100">
                <svg aria-hidden="true" className="mx-3 w-5 h-5 fill-current" fill="currentColor" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
